...
def compile_files_WMLS(path,exe):
    for root, dirs, files in os.walk(path):
        for file in files:
            original_path_file = os.path.join(root, file)
            if '.wmls' in file:
                os.system(fr'{exe} {original_path_file}')
...
exe_path=r'C:\Users\pecom\Desktop\joao-pedro-souza-master\WMLSComp.exe'
original_path_src =r'C:\Users\pecom\Desktop\joao-pedro-souza-master\src'
original_path_src_POSWEB=r'C:\Users\pecom\Desktop\joao-pedro-souza-master\src\POSWEB'


#criaçao dos novos diretorios
try:
    os.mkdir(r'C:\Users\pecom\Desktop\load')
    os.mkdir(r'C:\Users\pecom\Desktop\load\POSWEB')
    os.mkdir(r'C:\Users\pecom\Desktop\load\POSWEB\f')
    os.mkdir(r'C:\Users\pecom\Desktop\load\POSWEB\i')
except FileExistsError as e:
    print("Arquivo ja existe.")


#declaraçao dos novos diretorios
new_path_load=r'C:\Users\pecom\Desktop\load'
new_path_load_POSWEB=r'C:\Users\pecom\Desktop\load\POSWEB'
new_path_load_POSWEB_f=r'C:\Users\pecom\Desktop\load\POSWEB\f'
new_path_load_POSWEB_i=r'C:\Users\pecom\Desktop\load\POSWEB\i'
